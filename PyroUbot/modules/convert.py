...
<blockquote><b>🎨 ᴄᴏɴᴠᴇʀsɪ ᴍᴇᴅɪᴀ:
• <code>{0}toanime</code> - ᴘʜᴏᴛᴏ/ꜱᴛɪᴄᴋᴇʀ/ɢɪꜰ ᴛᴏ ᴀɴɪᴍᴇ
• <code>{0}toimg</code> - ꜱᴛɪᴄᴋᴇʀ/ɢɪꜰ ᴛᴏ ᴘʜᴏᴛᴏ
• <code>{0}tosticker</code> - ᴘʜᴏᴛᴏ ᴛᴏ ꜱᴛɪᴄᴋᴇʀ
• <code>{0}togif</code> - ꜱᴛɪᴄᴋᴇʀ ᴛᴏ ɢɪꜰ
• <code>{0}toaudio</code> - ᴠɪᴅᴇᴏ ᴛᴏ ᴀᴜᴅɪᴏ ᴍᴘ3</b></blockquote>

<blockquote><b>⚡ ᴜʙᴀʜ ꜰᴏʀᴍᴀᴛ ᴍᴇᴅɪᴀ ᴅᴇɴɢᴀɴ ᴄᴇᴘᴀᴛ!</b></blockquote>
"""
