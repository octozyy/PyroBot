...
__MODULE__ = "ʀᴇᴍᴏᴠᴇʙɢ"
__HELP__ = """
<b>🖼️ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ʀᴇᴍᴏᴠᴇ BG 🖼️</b>

<blockquote><b>✂️ ʀᴇᴍᴏᴠᴇ ʙᴀᴄᴋɢʀᴏᴜɴᴅ:
• <code>{0}rmbg</code> [ʀᴇᴘʟʏ ɪᴍᴀɢᴇ] - ʜᴀᴘᴜs ʟᴀᴛᴀʀ ʙᴇʟᴀᴋᴀɴɢ ɢᴀᴍʙᴀʀ</b></blockquote>

<blockquote><b>🎨 ʙᴜᴀᴛ ɢᴀᴍʙᴀʀ ᴛʀᴀɴsᴘᴀʀᴀɴ!</b></blockquote>
"""
