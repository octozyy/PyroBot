...
__HELP__ = """
<b>📁 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴜᴘʟᴏᴀᴅ ᴋᴇ ɢɪᴛʜᴜʙ 📁</b>

<blockquote><b>⬆️ ᴜᴘʟᴏᴀᴅ ꜰɪʟᴇ:
• <code>{0}upgh [email] [password]</code> - ʟᴏɢɪɴ ɢɪᴛʜᴜʙ
• ʀᴇᴘʟʏ ꜰɪʟᴇ ᴜɴᴛᴜᴋ ᴜɴɢɢᴀʜ</b></blockquote>

<blockquote><b>💾 sɪᴍᴘᴀɴ ꜰɪʟᴇ ᴅɪ ɢɪᴛʜᴜʙ ᴍᴇʟᴀʟᴜɪ API!</b></blockquote>
"""
