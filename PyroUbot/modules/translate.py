...
<blockquote><b>📝 ᴛʀᴀɴsʟᴀᴛɪᴏɴ & ᴛᴛs:
• <code>{0}tr [text]</code> - ᴛᴇʀᴊᴇᴍᴀʜ ᴛᴇxᴛ
• <code>{0}tts [text]</code> - ᴛᴇxᴛ ᴛᴏ sᴜᴀʀᴀ
• <code>{0}setlang [lang]</code> - sᴇᴛ ʙᴀʜᴀsᴀ ᴛʀᴀɴsʟᴀᴛᴇ</b></blockquote>

<blockquote><b>🗣️ ᴜʙᴀʜ ʙᴀʜᴀsᴀ ᴅᴇɴɢᴀɴ ᴍᴜᴅᴀʜ!</b></blockquote>
"""
