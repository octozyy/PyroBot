...
__HELP__ = """
<b>🌐 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴄᴇᴋ IP 🌐</b>

<blockquote><b>📍 ᴄᴇᴋ IP ᴀᴅᴅʀᴇss:
• <code>{0}ipaddress [IP]</code> - ɪɴꜰᴏ ᴀʟᴀᴍᴀᴛ IP</b></blockquote>

<blockquote><b>🔍 ᴛᴇᴍᴜᴋᴀɴ ʟᴏᴋᴀsɪ ᴅᴀʀɪ IP ᴀᴅᴅʀᴇss!</b></blockquote>
"""
