...
<blockquote><b>🚫 ɢʟᴏʙᴀʟ ᴀᴄᴛɪᴏɴs:
• <code>{0}gban</code> - ʙᴀɴ ᴜsᴇʀ ᴅᴀʀɪ sᴇᴍᴜᴀ ɢʀᴜᴘ
• <code>{0}ungban</code> - ᴜɴʙᴀɴ ᴜsᴇʀ ᴅᴀʀɪ sᴇᴍᴜᴀ ɢʀᴜᴘ
• <code>{0}gmute</code> - ᴍᴜᴛᴇ ᴜsᴇʀ ᴅᴀʀɪ sᴇᴍᴜᴀ ɢʀᴜᴘ
• <code>{0}ungmute</code> - ᴜɴᴍᴜᴛᴇ ᴜsᴇʀ ᴅᴀʀɪ sᴇᴍᴜᴀ ɢʀᴜᴘ</b></blockquote>

<blockquote><b>⚡ ᴋᴇʟᴏʟᴀ ᴜsᴇʀ ᴅɪ sᴇᴍᴜᴀ ɢʀᴜᴘ sᴇᴋᴀʟɪɢᴜs!</b></blockquote>
"""
