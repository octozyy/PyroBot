...
__MODULE__ = "ᴀᴅᴍɪɴ"
__HELP__ = """
<b>🛡️ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴀᴅᴍɪɴ 🛡️</b>

<blockquote><b>👥 ᴍᴀɴᴀᴊᴇᴍᴇɴ ᴀɴɢɢᴏᴛᴀ:
• <code>{0}kick</code> - ᴋɪᴄᴋ ᴀɴɢɢᴏᴛᴀ
• <code>{0}ban</code> - ʙᴀɴ ᴀɴɢɢᴏᴛᴀ
• <code>{0}mute</code> - ᴍᴜᴛᴇ ᴀɴɢɢᴏᴛᴀ
• <code>{0}unmute</code> - ᴜɴᴍᴜᴛᴇ ᴀɴɢɢᴏᴛᴀ
• <code>{0}unban</code> - ᴜɴʙᴀɴ ᴀɴɢɢᴏᴛᴀ
• <code>{0}promote</code> - ᴘʀᴏᴍᴏᴛᴇ ᴀᴅᴍɪɴ
• <code>{0}demote</code> - ᴅᴇᴍᴏᴛᴇ ᴀᴅᴍɪɴ</b></blockquote>

<blockquote><b>🔒 ᴍᴀɴᴀᴊᴇᴍᴇɴ ɪᴢɪɴ ɢʀᴜᴘ:
• <code>{0}lock</code> - ᴋᴜɴᴄɪ ᴘᴇsᴀɴ
• <code>{0}unlock</code> - ʙᴜᴋᴀ ᴋᴜɴᴄɪ
• <code>{0}locks</code> - ʟɪsᴛ ɪᴢɪɴ</b></blockquote>

<blockquote><b>📝 ᴄᴏɴᴛᴏʜ ᴘᴇɴɢɢᴜɴᴀᴀɴ:
• <code>{0}kick @username</code>
• <code>{0}lock msg</code>
• <code>{0}promote @username</code></b></blockquote>
"""
