__MODULE__ = "ʀᴇᴀᴄᴛɪᴏɴ"
__HELP__ = """
<b>😊 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ʀᴇᴀᴄᴛ 😊</b>

<blockquote><b>🎭 ʀᴇᴀᴄᴛɪᴏɴ ᴇᴍᴏᴊɪ:
• <code>{0}react [username]</code> - ʙᴇʀɪ ʀᴇᴀᴄᴛɪᴏɴ ᴇᴍᴏᴊɪ
• <code>{0}stopreact</code> - ʜᴇɴᴛɪᴋᴀɴ ʀᴇᴀᴄᴛɪᴏɴ</b></blockquote>

<blockquote><b>❤️ ᴛᴀᴍʙᴀʜ ᴇᴍᴏᴊɪ ʀᴇᴀᴄᴛɪᴏɴ ᴋᴇ ᴘᴇsᴀɴ!</b></blockquote>
"""
