...
__HELP__ = """
<b>🌐 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ sᴜʙᴅᴏᴍᴀɪɴ ᴄʀᴇᴀᴛᴏʀ 🌐</b>

<blockquote><b>🔧 ᴍᴀɴᴀᴊᴇᴍᴇɴ sᴜʙᴅᴏᴍᴀɪɴ:
• <code>{0}subdocreate [domain] [sub] [ip]</code> - ᴛᴀᴍʙᴀʜ sᴜʙᴅᴏᴍᴀɪɴ ᴋᴇ ᴄʟᴏᴜᴅꜰʟᴀʀᴇ
• <code>{0}listdomain</code> - ʟɪsᴛ ᴅᴏᴍᴀɪɴ
• <code>{0}domainlist</code> - ᴅᴀꜰᴛᴀʀ ᴅᴏᴍᴀɪɴ ᴛᴇʀsᴇᴅɪᴀ</b></blockquote>

<blockquote><b>📝 ᴄᴏɴᴛᴏʜ: <code>{0}subdocreate example.com test 192.168.1.1</code></b></blockquote>
"""
