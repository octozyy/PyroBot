...
__MODULE__ = "ᴄᴀʀʙᴏɴ"
__HELP__ = """
<b>🖼️ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴄᴀʀʙᴏɴ 🖼️</b>

<blockquote><b>🎨 ᴄʀᴇᴀᴛᴇ ᴄᴀʀʙᴏɴ:
• <code>{0}carbon [text]</code> - ʙᴜᴀᴛ ɪᴍᴀɢᴇ ᴄᴀʀʙᴏɴ ᴅᴀʀɪ ᴛᴇxᴛ</b></blockquote>

<blockquote><b>🖌️ sᴛʏʟɪsʜ ᴛᴇxᴛ ᴛᴏ ɪᴍᴀɢᴇ!</b></blockquote>
"""
