...
<blockquote><b>⬇️ ᴅᴏᴡɴʟᴏᴀᴅ ᴛᴇʀᴀʙᴏx:
• <code>{0}terabox [link]</code> - ᴅᴏᴡɴʟᴏᴀᴅ ᴠɪᴅᴇᴏ ᴅᴀʀɪ ᴛᴇʀᴀʙᴏx</b></blockquote>

<blockquote><b>🎥 ᴜɴᴅᴜʜ ᴠɪᴅᴇᴏ ʙᴇsᴀʀ ᴅᴀʀɪ ᴛᴇʀᴀʙᴏx!</b></blockquote>
"""
