...
<blockquote><b>📹 ʙᴜᴀᴛ ϙᴜᴏᴛᴇs ᴠɪᴅᴇᴏ:
• <code>{0}qvideo [link]</code> - ʙᴜᴀᴛ ϙᴜᴏᴛᴇs ᴠɪᴅᴇᴏ sᴇᴘᴇʀᴛɪ ᴛɪᴋᴛᴏᴋ</b></blockquote>

<blockquote><b>🎬 ᴜʙᴀʜ ᴠɪᴅᴇᴏ ᴍᴇɴᴊᴀᴅɪ ϙᴜᴏᴛᴇs ᴋᴇʀᴇɴ!</b></blockquote>
"""
