...
__HELP__ = """
<b>🌍 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴄᴏᴜɴᴛʀʏ ɪɴꜰᴏ 🌍</b>

<blockquote><b>📊 ɪɴꜰᴏ ɴᴇɢᴀʀᴀ:
• <code>{0}country [nama negara]</code> - ʟɪʜᴀᴛ ɪɴꜰᴏ ɴᴇɢᴀʀᴀ</b></blockquote>

<blockquote><b>🗺️ ᴛᴀʜᴜɪ ᴛᴇɴᴛᴀɴɢ ɴᴇɢᴀʀᴀ ᴅɪ ᴅᴜɴɪᴀ!</b></blockquote>
"""
