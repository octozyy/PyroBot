...
__MODULE__ = "ꜱᴛɪᴄᴋᴇʀ"
__HELP__ = """
<b>🎨 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ sᴛɪᴄᴋᴇʀ 🎨</b>

<blockquote><b>📝 ᴄʀᴇᴀᴛᴇ sᴛɪᴄᴋᴇʀs:
• <code>{0}q</code> - ᴛᴇxᴛ ᴛᴏ sᴛɪᴄᴋᴇʀ
• <code>{0}kang</code> - ᴀᴅᴅ sᴛɪᴄᴋᴇʀ ᴛᴏ ᴘᴀᴄᴋ
• <code>{0}tiny</code> - ᴍᴀᴋᴇ sᴛɪᴄᴋᴇʀ sᴍᴀʟʟ
• <code>{0}mmf</code> - ᴀᴅᴅ ᴛᴇxᴛ ᴛᴏ sᴛɪᴄᴋᴇʀ/ᴘʜᴏᴛᴏ</b></blockquote>

<blockquote><b>🖼️ ᴍᴀɴᴀᴊᴇᴍᴇɴ sᴛɪᴄᴋᴇʀ ᴅᴇɴɢᴀɴ ᴍᴜᴅᴀʜ!</b></blockquote>
"""
