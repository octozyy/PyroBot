...
<blockquote><b>📡 ᴘᴇsᴀɴ sɪᴀʀᴀɴ:
• <code>{0}gikes [type]</code> - sɪᴀʀᴀɴ ᴋᴇ ᴀʟʟ/ᴜsᴇʀs/ɢʀᴏᴜᴘs
• <code>{0}stopg</code> - ʜᴇɴᴛɪᴋᴀɴ sɪᴀʀᴀɴ
• <code>{0}bcfd</code> - sɪᴀʀᴀɴ ꜰᴏʀᴡᴀʀᴅ
• <code>{0}send</code> - ᴋɪʀɪᴍ ᴋᴇ ᴜsᴇʀ/ɢʀᴜᴘ
• <code>{0}autobc</code> - sɪᴀʀᴀɴ ᴏᴛᴏᴍᴀᴛɪs</b></blockquote>

<blockquote><b>⚙️ ᴏᴘsɪ ᴀᴜᴛᴏʙᴄ: |on/off |text |delay |remove |limit</b></blockquote>
"""
