...
__MODULE__ = "ᴘʀᴏꜰɪʟᴇꜱ"
__HELP__ = """
<b>👤 ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ᴘʀᴏꜰɪʟᴇs 👤</b>

<blockquote><b>⚙️ ᴇᴅɪᴛ ᴘʀᴏꜰɪʟ:
• <code>{0}setbio</code> - ᴜʙᴀʜ ʙɪᴏ ᴀᴋᴜɴ
• <code>{0}setname</code> - ᴜʙᴀʜ ɴᴀᴍᴀ ᴀᴋᴜɴ
• <code>{0}block</code> - ʙʟᴏᴋɪʀ ᴜsᴇʀ
• <code>{0}unblock</code> - ᴜɴʙʟᴏᴋɪʀ ᴜsᴇʀ</b></blockquote>

<blockquote><b>📊 ɪɴꜰᴏ ᴀᴋᴜɴ:
• <code>{0}info</code> - ɪɴꜰᴏ ᴀᴋᴜɴ ᴛᴇʟᴇɢʀᴀᴍ
• <code>{0}cinfo</code> - ɪɴꜰᴏ ɢʀᴜᴘ/ᴄʜᴀɴɴᴇʟ</b></blockquote>

<blockquote><b>🔧 ᴋᴇʟᴏʟᴀ ᴘʀᴏꜰɪʟ ᴅᴀɴ ʙʟᴏᴋɪʀᴀɴ!</b></blockquote>
"""
